...
def peptidebert_non_fouling(sequences: str) -> str:
    """
    Predict peptide non-fouling properties using a locally trained
    PeptideBERT-non-fouling checkpoint.
