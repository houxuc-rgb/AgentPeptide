...
def peptidebert_hemolysis(sequences: str) -> str:
    """
    Predict peptide hemolysis properties using a locally trained
    PeptideBERT-hemolysis checkpoint.
